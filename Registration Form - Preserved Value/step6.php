	...
	<div id='main'>
		...
		<form action='register.php' method='GET'>
			...
			<table border='3'>
				...
				<tr>
						<td colspan="3">	
							<input type="radio" value="Full" name="stype" <?php if($sType=='Full') echo "checked" ?>>Full <br>
							<input type="radio" value="Partial" name="stype" <?php if($sType=='Partial') echo "checked" ?>>Partial <br>
							<input type="radio" value="Payee" name="stype" <?php if($sType=='Payee') echo "checked" ?>>Payee
						</td>
				</tr>	
				...
				<tr>
					<td colspan="3">
						<button style="float:right">Submit Form</button>
